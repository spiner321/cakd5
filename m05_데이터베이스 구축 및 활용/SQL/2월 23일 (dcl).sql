...
IDENTIFIED BY JADE
DEFAULT TABLESPACE USERS
TEMPORARY TABLESPACE TEMP PROFILE DEFAULT; -- PROFILE DEFAULT : 자원 무한 배분
GRANT CONNECT, RESOURCE, CREATE VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO C##JADE;
...
-- # 사용자 삭제
--- # CASCADE를 사용하면 사용자 이름과 관련된 모든 데이터베이스 스키마가 데이터 사전으로부터 삭제
DROP USER C##TEST1;
