...
SELECT a14.고객번호, A15.고객번호, a14.제휴사, A15.제휴사, NVL(A14.구매금액, 0) "2014", NVL(A15.구매금액, 0) "2015", ROUND((NVL(A15.구매금액, 0)-NVL(A14.구매금액, 0))/A15.구매금액*100, 2) "증감률"
FROM AMT_14 A14
FULL OUTER JOIN AMT_15 A15
ON A14.고객번호 = A15.고객번호 AND A14.제휴사(+) = A15.제휴사
where NVL(A15.구매금액, 0) = 0;
